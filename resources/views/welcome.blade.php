<x-guest-layout>
    <!-- Main Hero Content -->
    <div class="container max-w-full px-4 py-48 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center" style="background-image: url('imgs/hero-background.jpg')"
        >
        <h1
            ...
            <span class="inline md:block">Welcome to Refugee</span>
        </h1>
        ...
        <div class="flex flex-col items-center mt-12 text-center">
            <span class="relative inline-flex w-full md:w-auto">
                <a href="{{ route('get.asile') }}" type="button"
            ...
            <div class="flex flex-wrap items-center sm:-mx-3">
                <div class="w-full md:w-1/2 md:px-3">
                    <div class="w-full pb-6 space-y-4 sm:max-w-md lg:max-w-lg lg:space-y-4 lg:pr-0 md:pb-0">
                        <h1
                            ...
                            <h3 class="text-xl">KNOW
                            </h3>
                            <h2 class="text-4xl text-green-600">OUR STORY ?</h2>
                            <!-- </h1> -->
                            <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus nemo incidunt
                                praesentium, ipsum
                                culpa minus eveniet, id nesciunt excepturi sit voluptate repudiandae. Explicabo,
                                incidunt
                                quia.
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md sm:rounded-xl">
                        <img src="{{ asset('imgs/about.png') }}" />
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="py-32 bg-slate-900" id="about-us">
        <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                        ...
                        src="{{ asset('imgs/service.jpg') }}" alt="feature image">
                </div>
                    ...
                    <div class="w-full lg:max-w-md">
                        ...
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Fast file processing</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">No Payments</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="font-medium text-gray-500">Accesible Community</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="pt-12 pb-24 bg-gray-50" id="services">
        <div class="my-16 text-center">
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                They passed by us</h2>
            <p class="text-xl text-slate-900 mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. soluta sapient</p>
        </div>
        <div class="grid sm:gap-20 lg:gap-1 lg:grid-cols-3 md:grid-cols-1 place-items-center">
            <div class="max-w-lg lg:max-w-sm p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                        src="{{ asset('imgs/Sans titre.png') }}">
                </div>
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Jemima Rashidwenze</a>
                </div>
            </div>
            <div class="max-w-lg my-20 lg:max-w-sm p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                        src="{{ asset('imgs/Sans titre (4).png') }}">
                </div>
                <div>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
                        deserunt
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Anton Nougaiev</a>
                </div>
            </div>
            <div class="max-w-lg lg:max-w-sm p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                        src="{{ asset('imgs/Sans titre (3).png') }}">
                </div>
                <div>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
                        deserunt
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Flexy Sunder</a>
                </div>
            </div>
        </div>
    </section>
