        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.asiles.store') }}">
                        @csrf
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <label for="phone" class="block text-sm font-medium text-gray-700">Pphone</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <label for="from" class="block text-sm font-medium text-gray-700">Orignie  Provenance</label>
                            <div class="mt-1">
